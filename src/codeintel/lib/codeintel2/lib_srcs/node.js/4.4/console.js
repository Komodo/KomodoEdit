...
/**
 * Used to calculate the duration of a specific operation. To start a
 * timer, call the console.time() method, giving it a unique label as the
 * only parameter. To stop the timer, and to get the elapsed time in
 * milliseconds, just call the [console.timeEnd()][] method, again passing
 * the timer&#39;s unique label as the parameter.
 * @param label
 */
