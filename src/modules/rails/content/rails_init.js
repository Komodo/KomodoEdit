...
this.generateRailsObject = function generateRailsObject(editor,
    ...
    if (part_names) {
        ...
        if (part_names.length == 2) {
            ...
            name_list = dialog_prompt2(ko.extensions.rails.capitalize(railsTypeName) + " values",
            ...
            for (var i = 0; i < part_names.length; i++) {
                ...
                var n = dialog_prompt(ko.extensions.rails.capitalize(railsTypeName) + " " + part_name + " name",
        ...
        name = dialog_prompt(ko.extensions.rails.capitalize(railsTypeName) + " name",
                             railsTypeName, "",
                             part_name_prompt);
    }
    if (!name) {
