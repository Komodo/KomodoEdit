...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("kopy/", "chrome://kopy/content/");
        window.require('kopy/kopy').load();
    } catch (e) {
        Cu.reportError("kopy: Exception while initializing");
        Cu.reportError(e);
    }
}
...
function unloadFromWindow(window) {
    if (!window) return;
    window.require('kopy/kopy').unload();
}
