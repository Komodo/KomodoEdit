(function() {
    ...
    function doMove()
    {
        ...
        commando.pinTipMessage('Moving: "'+local.cut.name+'", expand a folder to paste it');
        commando.navBack();
    }
    ...
    function doCopy()
    {
        ...
        commando.pinTipMessage('Copying: "'+local.copy.name+'", expand a folder to paste it');
        commando.navBack();
    }
