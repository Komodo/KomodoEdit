...
vals = {   'ASTC_CREATE_NEW_TRAN': 36,
    ...
    'SCE_UDL_SSL_CLASS': 51,
    'SCE_UDL_SSL_COMMENT': 42,
    'SCE_UDL_SSL_COMMENTBLOCK': 43,
    'SCE_UDL_SSL_DEFAULT': 41,
    'SCE_UDL_SSL_FUNCTION': 52,
    'SCE_UDL_SSL_IDENTIFIER': 47,
    'SCE_UDL_SSL_NUMBER': 44,
    'SCE_UDL_SSL_OPERATOR': 48,
    'SCE_UDL_SSL_REGEX': 49,
    'SCE_UDL_SSL_STRING': 45,
    'SCE_UDL_SSL_UPPER_BOUND': 52,
    'SCE_UDL_SSL_VARIABLE': 50,
    'SCE_UDL_SSL_WORD': 46,
    'SCE_UDL_TPL_COMMENT': 54,
    'SCE_UDL_TPL_COMMENTBLOCK': 55,
    'SCE_UDL_TPL_DEFAULT': 53,
    'SCE_UDL_TPL_IDENTIFIER': 59,
    'SCE_UDL_TPL_NUMBER': 56,
    'SCE_UDL_TPL_OPERATOR': 60,
    'SCE_UDL_TPL_STRING': 57,
    'SCE_UDL_TPL_UPPER_BOUND': 61,
    'SCE_UDL_TPL_VARIABLE': 61,
    'SCE_UDL_TPL_WORD': 58,
    'SCE_UDL_UPPER_BOUND': 61,
    'TRAN_FAMILY_CSL': 2,
    'TRAN_FAMILY_CSS': 1,
