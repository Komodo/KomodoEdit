...
181 166 66 Brass
217 217 25 Bright Gold
166 42 42 Brown
140 120 83 Bronze
166 125 61 Bronze II
95 159 159 Cadet Blue
217 135 25 Cool Copper
184 115 51 Copper
255 127 0 Coral
...
192 192 192 Grey
82 127 118 Green Copper
147 219 112 Green Yellow
33 94 33 Hunter Green
78 47 47 Indian Red
159 159 95 Khaki
192 217 217 Light Blue
168 168 168 Light Grey
143 143 189 Light Steel Blue
233 194 166 Light Wood
50 205 50 Lime Green
228 120 51 Mandarian Orange
142 35 107 Maroon
50 205 153 Medium Aquamarine
50 50 205 Medium Blue
...
113 113 0 active gold
184 38 25 active red
200 100 0 active orange
0 50 255 active blue
""".splitlines()
colors = {}
for line in data:
    if not line: continue
    r,g,b,rest = line.split(None, 3)
    rest = rest.replace(' ','').lower()
    r,g,b = map(int, (r,g,b))
    colors[rest] = r,g,b

while 1:
    name = raw_input("color name: ")
    if name not in colors:
        print 'unknown'
        continue
    r,g,b = colors[name]
    print colors[name], hex(r+g*256+b*256*256)
