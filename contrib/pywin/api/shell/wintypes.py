...
#from comtypes import IUnknown, STDMETHOD, HRESULT, GUID, ole32, REFIID
from comtypes import IUnknown, STDMETHOD, HRESULT, GUID

# ole32 = ???
REFIID = POINTER(GUID)

# -- why do we want Malloc? (EP 2007-08-28)
# from comtypes.com.mallocspy import IMalloc, MallocSpy
#### from comtypes.test.test_outparam import IMalloc
#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
import locale
...
IEnumIDList._methods_ = IUnknown._methods_ + [
	STDMETHOD(HRESULT, "Next", (c_ulong,
...
IShellFolder._methods_ = IUnknown._methods_ + [
	STDMETHOD(HRESULT, "ParseDisplayName", (HWND,
                                                ...
                                                POINTER(PIDL),
                                                POINTER(c_ulong))),
	STDMETHOD(HRESULT, "EnumObjects", (HWND,
                                           DWORD,
                                           POINTER(POINTER(IEnumIDList)))),
	STDMETHOD(HRESULT, "BindToObject", (PIDL,
                                            c_void_p,
                                            REFIID,
                                            POINTER(POINTER(IUnknown)))),
	STDMETHOD(HRESULT, "BindToStorage", (POINTER(ITEMIDLIST),
                                             c_void_p,
                                             REFIID,
                                             POINTER(POINTER(IUnknown)))),
	STDMETHOD(HRESULT, "CompareIDs", (LPARAM,
                                          PIDL,
                                          PIDL)),
	STDMETHOD(HRESULT, "CreateViewObject", (HWND,
                                                REFIID,
                                                POINTER(POINTER(IUnknown)))),
	STDMETHOD(HRESULT, "GetAttributesOf", (c_uint,
                                               POINTER(POINTER(ITEMIDLIST)),
                                               # idl array in reality
                                               POINTER(c_ulong))),
	STDMETHOD(HRESULT, "GetUIObjectOf", (HWND,
                                             c_uint,
                                             POINTER(POINTER(ITEMIDLIST)),
                                             #  idl array in reality
                                             REFIID,
                                             POINTER(c_uint),
                                             POINTER(POINTER(IUnknown)))),
	STDMETHOD(HRESULT, "GetDisplayNameOf", (POINTER(ITEMIDLIST),
                                                DWORD,
                                                POINTER(STRRET))),
	STDMETHOD(HRESULT, "SetNameOf", (HWND,
                                         POINTER(ITEMIDLIST),
                                         OLESTR,
                                         DWORD,
                                         POINTER(PIDL)))]
...
IContextMenu._methods_ = IUnknown._methods_ + [
	STDMETHOD(HRESULT, "QueryContextMenu", (c_ulong,
                                                c_uint,
                                                c_uint,
                                                c_uint,
                                                c_uint)),
	STDMETHOD(HRESULT, "InvokeCommand", (POINTER(CMINVOKECOMMANDINFOEX),)),                           
	STDMETHOD(HRESULT, "GetCommandString",  (c_uint,
                                                 c_uint,
                                                 c_uint,
                                                 c_ulong,	# addressof buffer
                                                 c_uint))]
...
IContextMenu3._methods_ = IContextMenu._methods_ + [
    STDMETHOD(HRESULT, "HandleMenuMsg2", (c_uint, WPARAM, LPARAM,
                                          POINTER(c_long)))]
